...
btn.addEventListener('click', function () {
  box.classList.toggle('hidden');
        ...
        var navigate_Fly = (parseFloat(navigator.appVersion) >= 5 && navigator.appName.indexOf("Netscape")>=0 )? true: false;
        var wind_w, wind_h, t='', IDs=new Array();
        for(i=0; i<floatimages.length; i++){
        t+=(butterfly_speed)?'<layer name="pic'+i+'" visibility="hide" width="10" height="10"><a href="javascript:hidebutterfly()">' : '<div id="pic'+i+'" style="position:absolute; visibility:hidden;width:5px; height:5px; z-index:3000"><a href="javascript:hidebutterfly()">';
        t+='<img src="'+floatimages[i]+'" name="p'+i+'" border="0" style="height: 100px; display:none" id="hide'+i+'">';
