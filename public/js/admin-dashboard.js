...
function addNewUser() {
  ...
  table.insertRow(table_len).outerHTML =
    "<tr id='demo'><td><input type='text' id='new_name' required></td><td><input type='text' id='new_country'></td><td><input type='text' id='new_age'></td><td><div type='button' class='addrow' onclick='addRow()'><i class='material-icons'>&#xE03B;</i></div></td></tr>";
...
function addRow() {
  ...
  row = table.insertRow(table_len).outerHTML =
    "<tr id='row" +
    table_len +
    "'><td id='name_row" +
    table_len +
    "'>" +
    new_name +
    "<span type='button' id='edit_button1" +
    table_len +
    "' value='Edit' class='edit' onclick='edit_row_cell1(" +
    table_len +
    ")'><i class='material-icons'>&#xE254;</i></span><span type='button' id='save_button1" +
    table_len +
    "' value='Save' class='save' onclick='save_row_cell1(" +
    table_len +
    ")'><i class='material-icons'>&#xE03B;</i></span></td><td id='country_row" +
    table_len +
    "'>" +
    new_country +
    "<span type='button' id='edit_button2" +
    table_len +
    "' value='Edit' class='edit' onclick='edit_row_cell2(" +
    table_len +
    ")'><i class='material-icons'>&#xE254;</i></span><span type='button' id='save_button2" +
    table_len +
    "' value='Save' class='save' onclick='save_row_cell2(" +
    table_len +
    ")'><i class='material-icons'>&#xE03B;</i></span></td><td id='age_row" +
    table_len +
    "'>" +
    new_age +
    "<span type='button' id='edit_button3" +
    table_len +
    "' value='Edit' class='edit' onclick='edit_row_cell3(" +
    table_len +
    ")'><i class='material-icons'>&#xE254;</i></span><span type='button' id='save_button3" +
    table_len +
    "' value='Save' class='save' onclick='save_row_cell3(" +
    table_len +
    ")'><i class='material-icons'>&#xE03B;</i></span></td><td><div type='button' onclick='deleteRow(this)'><i class='material-icons'>&#xE872;</i></div></td></tr>";
